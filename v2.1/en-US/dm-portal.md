...
- 不支持 [Binlog event filter](/v2.1/reference/tools/data-migration/features/overview.md#binlog-event-filter) 的 SQL pattern 方式
...
可以使用 DM Ansible 部署 DM Portal，具体部署方法参照[使用 DM Ansible 部署 DM 集群](/v2.1/how-to/deploy/data-migration-with-ansible.md)。
