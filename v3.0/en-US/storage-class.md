...
category: reference
aliases:
  - '/docs-cn/v3.0/tidb-in-kubernetes/reference/configuration/local-pv/'
---
...
最后通过 `kubectl apply` 安装 `local-volume-provisioner`。 后续创建 TiDB 集群或者备份的时候，配置相应的 `StorageClass` 使用。
